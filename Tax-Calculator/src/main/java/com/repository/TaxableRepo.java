...
@Repository
public class TaxableRepo {
    private DataSource dataSource;
    public TaxableRepo(DataSource dataSource) {
        this.dataSource = dataSource;
    }
    private static final String ALL = "select name,category,basic_salary,house_rent,medical,conveyance,commission,bonus,taxable,gross_tax from taxes";
